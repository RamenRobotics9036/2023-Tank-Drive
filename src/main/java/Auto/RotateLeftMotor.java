...
public class RotateLeftMotor {
    ...
    public RotateLeftMotor(DifferentialDrive m_drive, RelativeEncoder m_mainEncoder, RelativeEncoder secondaryEncoder, double m_targetRotation, double percentOutput) {
    ...
    public void execute() {
        m_drive.tankDrive(percentOutput, 0);
        // System.out.println("AUTO COMMAND SCHEDULED IN ROTATE LEFT MOTOR CLASS | OUTPUT SET TO: " + percentOutput);
    ...
    public boolean isFinished() {
        ...
        if (!isFinished) {
            // System.out.println("AUTO COMMAND CHECKED IN ROTATE LEFT MOTOR CLASS | IS FINISHED:" + (isFinished));
        }
        return isFinished;
    }
}
